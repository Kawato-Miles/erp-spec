...
折讓不自動下修該期預計金額：已收訖門檻維持「累計已收達該期預計金額」（[[收款項目狀態]]），業務要對齊就自行修改該期預計金額（[[帳務]] 明文可改、不需作廢發票），沒改所產生的差額由三方對帳警示兜底。否決自動下修：折讓與收款項目刻意脫鉤，自動連動把兩條線綁回去，部分折讓對多期分攤還要新規則。拍板：2026-08-03，Miles。
