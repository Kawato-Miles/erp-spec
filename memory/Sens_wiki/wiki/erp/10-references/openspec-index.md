...
| Spec | Vault 對應 |
|------|-----------|
| [config.yaml](../../../openspec/config.yaml) § 產品背景與目標 | [[wiki/erp/01-products/產品願景]]、[[階段規劃]] |
...
| [production-task/spec.md](../../../openspec/specs/production-task/spec.md) | v0.3 | [[生產任務]]、[[生產任務狀態]] |
