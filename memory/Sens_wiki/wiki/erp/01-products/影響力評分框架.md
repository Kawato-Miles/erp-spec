...
type: metric
source:
  - "Notion 資源：https://www.notion.so/d8ae867eb00947439a9c0fc47de52e84"
module:
  - 跨模組
status: active
...
開發優先排序參考。決定「該優先做哪些功能」（與 [[成功指標]] 的 KPI 不同：KPI 衡量「做到了沒」）。
...
| **缺失風險程度** | 失敗後是否直接影響[[成功指標|北極星指標]]的達成 |
...
- Notion 產品目標頁 § 五、成功指標 § 功能 Impact Score：產品目標
- Notion Impact Score DB：Impact Score
