...
依 [[2026-05-28-claude-research-agent-teams-vs-subagents]] 第 1 / 4 來源：
...
依 [[2026-05-28-claude-research-agent-teams-vs-subagents]] 第 2 來源：
...
- 與我們已驗證失敗的舊 [[multi-agent-discussion-protocol]]（Round 2-3 互審）本質相同：peer 互審導致需求無法收斂、輪次增加無新 insight
- 與「PM 單一收斂點」設計原則衝突
- ~7x token cost 與 Miles 痛點「Token 燒太兇」直接衝突

### 4. Anthropic 官方對 Agent Teams 的「不該用」清單剛好對應 ERP 場景

依 [[2026-05-28-claude-research-agent-teams-vs-subagents]] 第 1 來源：
...
具體執行：
1. [[sequential-design-collaboration]] 大改 — Phase 2/3 PM-中介來回上限 2 + Phase 4 verify consistency
2. 新建 [[dispatch-prompt-template]] — 5 區塊標準（採 Anthropic 官方建議結構）
3. [[multi-agent-discussion-protocol]] 標 `deprecated-verify-only`
...
| 若 Phase 4 verify consistency 兩張對照表足以取代 [[multi-agent-discussion-protocol]]，則完全 deprecate 後者 | Miles | 2026-06 內 |
...
- [[2026-05-28-claude-research-agent-teams-vs-subagents]] — 原始研究材料（含 5 個來源 URL）
- [[sequential-design-collaboration]] — 新主協議（採 sub-agent 模式）
- [[dispatch-prompt-template]] — Dispatch prompt 5 區塊標準
- [[multi-agent-discussion-protocol]] — 舊協議（deprecated-verify-only）
