...
|-----------|-----------|------|------|
| [[審稿人員]] | 審稿平台 | 製前（審稿階段） | 確認稿件合規、製作稿件 |
| [[品檢人員]] | 工廠平台 | 製後（打樣印製階段） | 依訂單進行 QC，記錄檢驗結果 |
...
1. [[XM-002-印務 vs 印務主管權責邊界|XM-002-印務 vs 印務主管權責邊界（已封存）]] — 印務（執行）能直接建生產任務嗎？還是需印務主管批准？
2. [[ORD-001-會計階段標記是否錯誤|ORD-001（已封存）]] — Notion DB 標記會計「僅審稿階段」是否錯誤？
3. [[XM-003-訂單管理人 vs 業務權責邊界|XM-003（已封存）]] — 兩者都有訂單 R/W 權限，工單異動執行責任在誰？
4. [[QC-001-OpenSpec 品管是否拆審稿與 QC|QC-001-OpenSpec 品管是否拆審稿與 QC（已封存）]] — OpenSpec「品管」是否該拆為「審稿」+「QC」？
