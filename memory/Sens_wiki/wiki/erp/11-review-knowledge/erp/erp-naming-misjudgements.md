...
## 一、案例 1：2026-05-08「收款項目待收金額」改名建議

**背景**：審查 `refactor-order-adjustment-with-watchlists` change 時，建議將「應收金額」改為「收款項目待收金額」。

**理由（誤審當時）**：
- 「PaymentPlan 收款項目層 vs Order 訂單層的應收名稱衝突」
...
**教訓 1**：學術名稱衝突 ≠ 業務認知衝突
- UI 上下文已能區分「Payment 是訂單的還是收款項目的」
- 強行直譯只會增加閱讀成本
...
2. **去重**：搜尋既有案例（如「收款項目待收金額」「watchlist」），相似度高建議擴充而非新增
