...
- **流程串接**：
  ...
  5. **諮詢結束分支**（諮詢人員動作）：
     ...
     - 不做大貨 → US-CR-005 建諮詢訂單收尾
     - 取消預約 → US-CR-006 建諮詢訂單（已取消終態）+ 半額退款（連到情境 16 退款流程）
