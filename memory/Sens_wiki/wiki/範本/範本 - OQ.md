...
<這個問題卡在哪：現況怎麼寫、缺什麼或與什麼衝突、不拍板為什麼走不下去。矛盾型問題並列矛盾兩方的出處。另註明矛盾來自既有正本，還是本次討論產生>
...
<一句話講清楚採哪案。理由寫兩面：這案的營運語意為什麼站得住、被否決的那案哪裡不成立。附拍板日期與拍板者>

落地去處：<決議改了哪些正本卡，逐卡 [[<卡名>]]。無需落地則寫明「無需落地（現況即定案）」>

<!-- 起手提醒（填完刪除本註解）：
- 撰寫規則與稽核維度：見 08-open-questions/規範 - OQ（一卡一議題／範圍宣告／檔名序號／段落紀律）
- 去重與封存流程、audience 判定：見 .claude/skills/oq-manage/SKILL.md
- 合規樣貌對照：08-open-questions/範例 - OQ
