...
詳見 [[../11-review-knowledge/_shared/audit-failure-patterns]]（規劃中）。簡述：
...
| [[index]] | LLM 載入決策入口（本框架 Step 2 的對照表）|
...
| [[../11-review-knowledge/_shared/audit-failure-patterns]] | 稽核五大反模式追蹤卡（規劃中，本框架 § 9.1 紀錄正本）|
