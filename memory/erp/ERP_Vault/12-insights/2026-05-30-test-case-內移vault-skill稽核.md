...
related-vault:
  - "[[../00-meta/wiki-schema]]"
  - "[[../00-meta/sync-workflow]]"
  - "[[../00-meta/scope-boundary]]"
  - "[[../00-meta/business-logic-writing-guide]]"
  - "[[../13-user-stories/README]]"
related-oq:
  - BI-12
  - BI-13
expected-action-at:   # 事件觸發（非日期）：Miles 完成 Obsidian 架構調整後
---
...
稽核 `erp-test-case` skill 是否過時，揭露核心轉折：test case 的管理正本應從 Notion 移進 Vault（Obsidian），Notion 降為對外發布版，比照已內移的 [[../13-user-stories/README|User Story]]。
...
- [[../00-meta/wiki-schema]]（§ 一/四/五/七 + 維度 14）
- [[../00-meta/sync-workflow]]（新增流程 1-C）
- [[../00-meta/scope-boundary]]（補 test case 定位）
- [[../00-meta/business-logic-writing-guide]]（L142 憲法句）
