...
### Step 3 待辦（vault 商業邏輯 + 諮詢 US 對齊，衝突風險低、相對獨立）
- `付款發票邏輯.md` + `payment-invoice-scenarios.md`：舊詞（付款計畫 / 預計發票 / PaymentInvoice junction / 依序填滿）→ 新模型
- US-CR-005 / US-CR-006：去 invoice_option + 半額退費對齊
- US-ORD-010 補收訂單模式 vs US-ORD-026 補收 OA 模式：標註取捨或廢止
