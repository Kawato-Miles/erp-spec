...
> 協議全文見 `.claude/agents/knowledge/three-perspective-protocol.md`。
...
預期分歧點：
- 與 CEO 視角：預期對方可能在 [議題] 上有不同看法，因為 [理由]
- 與 ERP 顧問：預期對方可能在 [議題] 上有不同看法，因為 [理由]
...
對 CEO 視角 Round 1 的回應：
- [議題 1]：同意 / 部分同意 / 不同意 — [具體理由 + 補充或修正方向]
- [議題 2]：...

對 ERP 顧問 Round 1 的回應：
- [議題 1]：同意 / 部分同意 / 不同意 — [具體理由 + 補充或修正方向]
- [議題 2]：...
...
本輪立場摘要：
[是否調整了 Round 1 的任何立場？調整了什麼、為什麼？]
```

## Round 3 格式（僅在有未解爭議時執行）
