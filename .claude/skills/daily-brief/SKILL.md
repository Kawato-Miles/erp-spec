...
```bash
grep -A 3 "^## \[$(date -v-1d +%Y-%m-%d)" /Users/b-f-03-029/Sens/memory/Sens_wiki/wiki/erp/00-meta/audit-log.md
```
...
- [[../../memory/Sens_wiki/wiki/erp/00-meta/audit-log|Audit Log]] — daily-brief 寫入記錄
