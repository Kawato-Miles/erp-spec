...
|------|---------|---------|-----------|
| PI-003 | ReviewRound 內 file_role 枚舉範圍確認 | 中 | [open](https://www.notion.so/3473886511fa812e9189fbc4625b54f8) |
| PI-004 | 審稿人員能力不足時的自動分配降級策略 | 高 | [open](https://www.notion.so/3473886511fa816cbd00e0fd216373d4) |
...
- [ ] 更新 PI-005 為「已完成」+ 決議與理由（見上）
- [ ] 更新 PI-002 為「已完成」+ 決議與理由（見上）
- [ ] 建立 PI-008（角色拆分未來檢視）
- [ ] 建立圖編器 Preflight 追蹤項（另開 change 或 OQ，由 Miles 決定形式）
