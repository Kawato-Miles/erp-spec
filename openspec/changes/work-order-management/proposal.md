...
- **未拍板依賴（阻斷級三題，已開 OQ 卡待 Miles 裁決）**：[PT-028 工單已交付觸發條件](../../../memory/Sens_wiki/wiki/erp/08-open-questions/PT-028-工單已交付觸發條件正本矛盾.md)、[PT-029 計價快照四分項工序費缺席](../../../memory/Sens_wiki/wiki/erp/08-open-questions/PT-029-計價快照四分項與計價引擎工序費缺席.md)、[PT-030 數量換算下行取整方向](../../../memory/Sens_wiki/wiki/erp/08-open-questions/PT-030-數量換算下行取整方向表述缺口.md)。設計已做三方向承接或暫置，裁決後回補，不阻斷 artifact 產出（問寫分離）。其餘 OQ 見 design.md § Open Questions。
