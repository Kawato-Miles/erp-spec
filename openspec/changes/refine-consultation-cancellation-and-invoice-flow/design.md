...
- 諮詢人員或諮詢主管 hit「取消諮詢」按鈕已是充分的人工授權
...
**決策**：限「當前 `consultant_id` 自己」（已認領該諮詢單的諮詢人員）+「諮詢主管」（可代為取消），**業務不可**。

**理由**：
- 諮詢相關所有動作（認領 / 編輯 consultant_note / 結束諮詢分支）已由諮詢人員擁有，取消權限對齊
- 業務不負責諮詢階段操作 — 沿用既有「諮詢人員 = 諮詢階段唯一操作者」設計
- 諮詢主管的代為操作沿用既有 [諮詢人員認領 § 主管代為認領](../../specs/consultation-request/spec.md) 設計範式
...
**緩解**：
- 諮詢主管可代為取消（沿用「諮詢主管代為認領」設計範式）
- 業務若遇到客戶要求取消、SHALL 通知諮詢主管處理
...
1. 諮詢取消按鈕權限改寫（限 consultant_id 自己 + 諮詢主管、業務隱藏）
...
4. 業務不可取消諮詢，遇客戶要求取消 SHALL 通知諮詢主管
