...
Skill 會自動引導完成 Spec 撰寫工作流程（見 `.claude/skills/erp-spec/SKILL.md` Step 1-5）。
...
| **Spec 撰寫 / 迭代** | 見「§ 如何開始 Spec 迭代」 → 觸發 `erp-spec` Skill | 迭代時參考 `memory/erp/spec-iteration-workflow.md` |
