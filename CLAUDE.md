...
| 情境驗證 / 補情境 | Notion 業務情境 DB + 對應 `state-machines*.md` section | `user-scenarios.md` |
| 確認 / 解答 Open Question | 查詢 Notion OQ DB（見 § OQ 工作流）+ 對應 `state-machines*.md` | — |
| 使用者故事 / 角色需求 | `user-scenarios.md` | `scenarios.md` |
| 術語查詢 | `glossary.md` | — |
| 產品目標 / KPI | `product-goals.md` | — |
| 資料模型查詢 / 欄位確認 | `docs/data-model.md` | — |
| **Prototype 製作** | `memory/shared/prototype-guidelines.md` + 對應 Spec + Notion 業務情境 DB + state-machines.md | `ui-design-system.md`、`user-scenarios.md`、`test-cases.md` |
