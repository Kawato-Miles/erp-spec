...
| 狀態機（跨模組）| `openspec/specs/state-machines/spec.md` | https://www.notion.so/32c3886511fa81539eb9d3c97630caa0 | — | 草稿（2026-05-22 resolve-consultation-request-gaps-cr-1-cr-2 歸檔 MODIFIED「諮詢單狀態機（v2 簡化）」「待諮詢」狀態說明改自我認領 + 角色權責對齊純自派 + Scenario「業務指派諮詢人員」rename 為「諮詢人員自我認領」+ 涉及諮詢的 Scenarios GIVEN「已指派」→「已認領」+ MODIFIED「訂單狀態機」Scenario「諮詢結束不做大貨建諮詢訂單」GIVEN「已指派」→「已認領」；2026-05-20 reclassify-qc-and-add-inspection 歸檔 MODIFIED「跨實體狀態向上傳遞鏈」明示 type=production 走鏈、QC/inspection PT 不走鏈 + MODIFIED「完成度計算」公式 pt_qc_passed 改自 ProductionTaskWorkRecord）|
| 商業流程（跨模組）| `openspec/specs/business-processes/spec.md` | https://www.notion.so/32c3886511fa81ccaaf9fbfd3882f19a | — | 草稿（2026-05-22 resolve-consultation-request-gaps-cr-1-cr-2 歸檔 MODIFIED「諮詢前置流程端到端規則」ASCII 流程圖「業務指派 consultant_id」→「諮詢人員自我認領 consultant_id」+ 補諮詢人員 / 客戶討論段註記 consultant_note 編輯 / consultation_topic 唯讀 + 補做大貨分支需求單 requirement_note 雙區塊合併帶入；2026-05-20 reclassify-qc-and-add-inspection 歸檔 MODIFIED「四層計算精確流程」層級 1 公式從 QCRecord 改為 ProductionTaskWorkRecord 累計）|
