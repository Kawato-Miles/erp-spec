...
| 稿件審查 | `openspec/specs/prepress-review/spec.md` | https://www.notion.so/32c3886511fa80eab36aded242f6deb9 | v1.3 | 草稿（v1.3：refactor-review-round-model 2026-04-22 歸檔 — Round 雙端聚合 + ActivityLog 清理 + 印件狀態同步規則）|
