...
- 應用位置：scenarios.md、state-machines.md、business-process.md 等所有用戶可見文件
...
| 討論收斂後 | 新增 / 解答 / 更新 OQ 至 Notion；同步 Spec 與 memory 檔案 |
...
| 使用者故事 / 角色需求 | Notion 使用者情境：https://www.notion.so/32c3886511fa8144b38adc9266395d15 | — |
| 術語查詢 | `glossary.md` | — |
