...
|------|--------------|----------------------|------|------|
| 需求單 | `openspec/specs/quote-request/spec.md` | https://www.notion.so/3293886511fa80998ac0e8cdf555da68 | v3.0 | 草稿（v3.0：relocate-sales-manager-approval-from-quote-to-order 2026-05-07 歸檔 — 業務主管 gate 整個移到訂單階段；移除「審核業務主管指定」/「業務主管核可議價推進」/「核可條件預留欄位」/「業務主管側選單與兩個頁面」/「資料可見範圍」/「Supervisor 重新指定業務主管」六個 Requirement、6 狀態變回 5 狀態；payment_terms_note 保留作為轉訂單帶入欄位）|
| 訂單管理 | `openspec/specs/order-management/spec.md` | https://www.notion.so/32c3886511fa806bad41d755349b0567 | v1.0 | 草稿（v1.0：relocate-sales-manager-approval-from-quote-to-order 2026-05-07 歸檔 — 新增「待業務主管審核」訂單狀態 + Order 加 4 個審核欄位（approved_by_sales_manager_id / approval_required / payment_terms_note / lastApprovedPaymentTermsNote）+「業務主管核准訂單」/「業務主管於訂單模組的資料可見範圍」/「Supervisor 重新指定訂單業務主管」三個 Requirement）|
