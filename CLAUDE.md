...
| 訂單款項與發票 13 業務情境（產 user story / test case 原始材料）| `memory/erp/payment-invoice-scenarios.md`（13 情境 475 行）；索引：`memory/erp/ERP_Vault/04-business-logic/付款發票邏輯.md`（含 § 五B 七實體連帶矩陣）；外部硬約束：`memory/erp/ERP_Vault/04-business-logic/發票法規硬約束-ezPay-MIG.md`（ezPay + MIG 法規）；領域分類：`memory/erp/ERP_Vault/00-meta/business-domain-taxonomy.md` § L1.6 Billing & Cash；**規劃前必跑** `erp-planning-pre-check` skill（雙軸稽核 + 5 步驟含閉環）|
