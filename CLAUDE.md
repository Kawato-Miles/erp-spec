...
| 情境驗證 / 補情境 | Notion 業務情境 DB + Notion 狀態變化 對應章節 | `user-scenarios.md` |
...
| **Prototype 製作** | `memory/shared/prototype-guidelines.md` + 對應 Spec + Notion 業務情境 DB + Notion 狀態變化 | `ui-design-system.md`、`user-scenarios.md`、`test-cases.md` |
